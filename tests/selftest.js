...
step(function () {
  ...
  /* 5. cambio de categoria: disenador â†’ 23, vuelta a nicho â†’ 112 */
  step(function () {
...
ok(gridCount() === 24, "catalogBackInitial24", "initial grid=" + gridCount());
  ...
  /* 9. pack nicho-5: abrir, tamano 3ml, precio 48, 112 items, seleccion, confirmar */
  step(function () {
    var tile = document.querySelector('[data-promo-filter="nicho"]');
    if (tile) { tile.click(); }
  ...
  step(function () {
    ...
    ok(document.querySelectorAll("#packProductGrid .pack-product-item").length === 112, "packItems112", "items=" + document.querySelectorAll("#packProductGrid .pack-product-item").length);

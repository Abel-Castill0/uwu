...
(async () => {
  ...
  const svg = `<svg width="${W}" height="${H}" xmlns="http://www.w3.org/2000/svg">
    ...
    <text x="${W / 2}" y="556" text-anchor="middle" font-family="Helvetica, Arial, sans-serif" font-size="22" letter-spacing="3" fill="#9A8270">www.fraganceobession.com · Lima, Peru</text>
  </svg>`;

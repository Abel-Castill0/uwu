...
- **Catálogo: nicho 115→116, diseñador 23→24** (Fierezza es nicho pero no cuenta para el pack por estar "Próximamente"; Eden-Roc sí cuenta en diseñador). `tests/selftest.js` actualizado (`catalogDisenador23`→`catalogDisenador24`; `packItems115` sin cambio porque excluye a Fierezza).
